<template>
  ...
  <a-drawer v-model:open="scheduleCategoryEditOverlayVisible" @close="resetForm()">
    <a-form>
      <div class="mb-2">
        Title
        <a-input size="large" v-model:value="scheduleCategoryFormData.title"></a-input>
      </div>

      <div class="mb-2">
        Description
        <a-input size="large" v-model:value="scheduleCategoryFormData.description"></a-input>
      </div>

      <div class="mb-2">
        Color
        <a-input size="large" type="color" v-model:value="scheduleCategoryFormData.color"></a-input>
      </div>
